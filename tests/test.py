...
Test inp2unv converter on examples
...
from inp2unv import clean, inp2unv
...
# Convert INP files
def convert_inp_files_in(folder):
    ...
    for file_name in scan_all_files_in(folder, '.inp'):
        ...
        try:
            inp2unv.Converter(file_name).run()
        except:
